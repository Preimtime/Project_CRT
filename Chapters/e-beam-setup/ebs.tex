...
A schematic of the supplied power is shown in \cref{fig:schematics of wiring}. The pin i.c. is connected to the g2, g4 lenses. A small ac or dc voltage is necessary to drive the heater filament f. This part of the setup is explained in \cref{sec:Heater}.
...
\begin{figure}[ht]
	...
	\begin{subfigure}[b]
			\missingfigure[figwidth=0.9\textwidth]{picture of ac bias voltage}
