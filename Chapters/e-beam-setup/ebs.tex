...
Our ac-power supply (figure \ref{fig:heater_circuit} shows its circuit diagram) consists of an isolation transformer (form grid voltage \todo[author=Frank]{what is form grid voltage?} to 12 V), its primary  and secondary circuits are isolated up to \SI{4}{\kilo\volt} \cite{DS44231-DataSheet} \todo[author=Frank]{\SI{4}{\kilo\volt} soruce?}. The power supply has two  banana plug sockets to connect to the heater filament. 
